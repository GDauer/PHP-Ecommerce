								...
								<div class="col-md-12">
									...
									<div class="woocommerce-billing-fields">
										...
										<div class="row">
											...
											<div class="col-sm-3">
												<p id="billing_number_1_field" class="form-row form-row-wide number-field validate-required">
													...
													<input type="text" value="<?php echo htmlspecialchars( $address["desnumber"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" placeholder="Número" id="billing_number" name="desnumber" class="input-text ">
												</p>
											</div>
										</div>
										...
										<div id="order_review" style="position: relative;">
											...
											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
												<input type="radio" checked="" id="method-pagseguro" name="payment-method" value="1" style="float: left; margin: 30px">
											...
											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
												...
												<label class="" for="method-boleto"><img style="height: 64px" src="/res/site/img/itau.jpg" /></label>
											</p><br /><br />
											<div id="payment">
												<div class="form-row place-order">
													<input type="submit" style="float: right" data-value="Place order" value="Continuar" id="place_order" name="woocommerce_checkout_place_order" class="button alt">
													<input type="submit" style="float: left" data-value="Place order" value="Cancelar" id="cancel" name="woocommerce_checkout_place_order" class="button alt" formaction="/cancel">
												</div>
												<div class="clear"></div>
											</div>
										</div>
