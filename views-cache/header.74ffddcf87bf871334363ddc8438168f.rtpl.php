    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="/admin/categories"><i class="fa fa-umbrella"></i> <span>Categorias</span></a></li>
                <li><a href="/admin/products"><i class="fa fa-credit-card"></i> <span>Produtos</span></a></li>
                <li class="treeview">
